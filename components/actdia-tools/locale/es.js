export default {
  ...
  'Brings the selected item one level forward in the diagram.': 'Trae el elemento seleccionado un nivel adelante en el diagrama.',
  ...
  'Dash': 'Guión',
  'Dash of the connection.': 'Guión de la conexión.',
  ...
  'Draw the conection orthonally.': 'Dibujar la conexión ortogonalmente.',
  'Draw the end marker for all connections.': 'Dibujar el marcador de fin para todas las conexiones.',
  'Draw the marker start of the connection.': 'Dibuja el marcador de inicio de la conexión.',
  'Draw the marker end of the connection.': 'Dibuja el marcador de fin de la conexión.',
  'Draw the start marker for all connections.': 'Dibujar el marcador de inicio para todas las conexiones.',
  'Edit': 'Editar',
  'Edit operations': 'Operaciones de edición',
  'End': 'Fin',
  'Endpoint offset from the node.': 'Desplazamiento del trazado al nodo.',
  ...
  'Gap': 'Espacio',
  'Gap both': 'Ambos espacios',
  'Gap end': 'Espacio fin',
  'Gap start': 'Espacio inicio',
  'File': 'Archivo',
  ...
  'Loading...': 'Cargando...',
  'Marker start': 'Marcador de inicio',
  'Name': 'Nombre',
  'New': 'Nuevo',
  'No': 'No',
  ...
  'Path': 'Trazo',
  'Path design': 'Diseño del trazo',
  'Redo': 'Rehacer',
  'Redo the last undone action.': 'Rehace la última acción deshecha.',
  'Rotate': 'Rotar',
  'Rotate clockwise': 'Rotar sentido horario',
  'Rotate counterclockwise': 'Rotar sentido antihorario',
  'Rotates the selected item 90 degrees clockwise.': 'Rota el elemento seleccionado 90 grados en el sentido de las agujas del reloj.',
  'Rotates the selected item 90 degrees counterclockwise.': 'Rota el elemento seleccionado 90 grados en sentido contrario a las agujas del reloj.',
  'Save': 'Guardar',
  'Saves the diagram.': 'Guarda el diagrama.',
  'Send backward': 'Enviar atrás',
  'Send to back': 'Enviar al fondo',
  'Sends the selected item one level back in the diagram.': 'Envía el elemento seleccionado un nivel atrás en el diagrama.',
  ...
  'Stroke width of the connection.': 'Ancho de trazo de la conexión.',
  'Style': 'Estilo',
