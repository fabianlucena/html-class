export default {
  ...
  'no data sent or received yet.': 'aún no hay datos enviados o recibidos.',
  ...
  'received: %s': 'recibido: %s',
  'sent: %s': 'enviado: %s',
  'Status: %s': 'Estado: %s',
  'Text': 'Texto',
  'The connector "%s" does not accept connections of type: "%s".': 'El conector "%s" no acepta conexiones del tipo: "%s".',
  'The connector "%s" does not accept multiple connections.': 'El conector "%s" no acepta múltiples conexiones.',
  'true': 'verdadero',
