export default async function create({ actdia, Node }) {
  ...
  return class BCTo7Segments extends Node {
    ...
    updateStatus() {
      const q0 = this.connectors.find(c => c.name === 'q0').received >= 0.5;
      const q1 = this.connectors.find(c => c.name === 'q1').received >= 0.5;
      const q2 = this.connectors.find(c => c.name === 'q2').received >= 0.5;
      const q3 = this.connectors.find(c => c.name === 'q3').received >= 0.5;
